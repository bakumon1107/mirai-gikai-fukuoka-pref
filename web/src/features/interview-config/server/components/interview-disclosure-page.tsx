      ...
      <div className="bg-white rounded-2xl p-6 space-y-4">
        ...
        <div className="text-sm leading-[1.83] text-black space-y-4">
          ...
          <div>
            ...
            <p className="mt-1">
              本インタビューを通じて収集された回答データは、今後の政策検討における基礎資料として活用いたします。個人の意見を特定の偏り（バイアス）なく集約し、客観性の高い政策議論に役立てることを目的としています。
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-2 space-y-2 list-none">
              ...
              <li>
                ...
                回答内容は、
                {formatPolicyReviewPhrase(siteConfig.managingParty, "における")}
                、およびAIを用いた統計的分析に限定して活用いたします。
              </li>
              <li>
